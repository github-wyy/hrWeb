    ...
    <el-container>
      <el-header>
        <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal"
          ...
          <el-menu-item index="2" v-if="token != ''"><font-awesome-icon icon="users" />&nbsp;人事管理</el-menu-item>
          <el-menu-item index="3" v-if="token == ''"><font-awesome-icon icon="deaf" />&nbsp;登录</el-menu-item>
          <el-menu-item index="8" v-if="token != ''"><font-awesome-icon icon="user-secret" />&nbsp;注销</el-menu-item>
        </el-menu>
      </el-header>
      <el-main>
        ...
        <el-row>
          ...
          <el-col :sm="20">
            <el-divider content-position="right">
              <strong><i class="el-icon-s-flag"></i>&nbsp;HR - 管理系统&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="el-icon-s-custom"></i></strong>
            </el-divider>
          </el-col>
        </el-row>
      </el-footer>
...
export default {
  ...
  computed: {
    ...mapGetters(['mid', 'privilege', 'name', 'token']),
